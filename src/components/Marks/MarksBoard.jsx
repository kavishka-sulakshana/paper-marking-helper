...
const MarksBoard = ({ result, downUrl }) => {
            ...
            <div className='rounded p-4 m-2 border-2 flex flex-col bg-stone-200'>
                ...
                <div className='px-3 pt-4 pb-4 '>
                    <div className='flex justify-between px-4 py-2 m-1 bg-stone-700 rounded text-teal-50'>
                        ...
                        {(downUrl!=='' && downUrl !== 'error') && <a href={downUrl} target="_blank" className='text-blue-300 cursor-pointer'>Download PDF</a>}
                        {(downUrl === 'error') && <div className='text-red-300'>Not marked yet</div>}
                    </div>
                </div>
            </div>
        </div>
